...
export default class FuzzyFinderView {
  ...
  // TODO Refactor to operate in terms of URIs instead of file paths
  ...
  // NEXT: Inline calls to this in existing setItems() callsites
  // THEN: Enhance buffer-view as needed to support remote buffers
...
class FuzzyFinderItem {
  constructor ({filePath, label, filterQuery, matches, repository}) {
